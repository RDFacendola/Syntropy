    ...
    namespace reflection
    {
        ...
        private:
            ...
            struct HolderT : Holder
            {
                ...
                template <typename TValue, typename... TArguments>
                explicit HolderT(std::in_place_type_t<TValue>, TArguments&&... arguments);

                template< typename TValue, typename TInitializerList, typename... TArguments >
                explicit HolderT(std::in_place_type_t<TValue>, std::initializer_list<TInitializerList> initializer_list, TArguments&&... arguments);

                virtual const Type& GetType() const noexcept override;

                virtual const type_info& GetTypeInfo() const noexcept override;

                virtual Holder* Clone() const noexcept override;
...
namespace syntropy
{
    namespace reflection
    {
        ...
        /************************************************************************/
        /* ANY :: HOLDER T <TCONTENT>                                           */
        /************************************************************************/

        template <typename TContent>
        template <typename TValue>
        Any::HolderT<TContent>::HolderT(TValue&& value)
        ...
        template <typename TContent>
        template <typename TValue, typename... TArguments>
        Any::HolderT<TContent>::HolderT(std::in_place_type_t<TValue>, TArguments&&... arguments)
        ...
        template <typename TContent>
        template< typename TValue, typename TInitializerList, typename... TArguments>
        Any::HolderT<TContent>::HolderT(std::in_place_type_t<TValue>, std::initializer_list<TInitializerList> initializer_list, TArguments&&... arguments)
