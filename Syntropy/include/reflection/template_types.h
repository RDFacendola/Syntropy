...
namespace syntropy {
    ...
    namespace reflection {
        ...
        struct TemplateClassName
        {
            ...
            static std::string GenerateName(const char* base_name) noexcept
            {
                std::string name_;
                ...
                name_.append(base_name)
                     .append("<")
                     .append(TemplateClassArgumentName<TType...>::GenerateName())
                     .append(">");
        ...
        private:
            ...
            struct TemplateClassArgumentName
            {
                ...
                static std::string GenerateName() noexcept
                {
                    ...
                    name << TypeOf<TType>()
                        << ", "
                        << TemplateClassArgumentName<TRestType...>::GenerateName();
