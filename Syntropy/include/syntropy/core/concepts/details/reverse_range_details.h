...
namespace Syntropy::Ranges::Details
{
    ...
    class ReverseRange
    {
        ...
        friend constexpr URange Reverse(Immutable<ReverseRange<URange>> range) noexcept;

    public:

        /// \brief Default constructor.
        constexpr ReverseRange() = default;

        /// \brief Default copy-constructor.
        constexpr ReverseRange(Immutable<ReverseRange> rhs) = default;

        /// \brief Create a new reverse range.
        template <Ranges::Concepts::BidirectionalRange URange = TRange>
        constexpr explicit ReverseRange(Immutable<URange> range) noexcept;

        /// \brief Default destructor.
        ~ReverseRange() = default;

        /// \brief Default copy-assignment operator.
        constexpr Mutable<ReverseRange> operator=(Immutable<ReverseRange> rhs) = default;
...
namespace Syntropy::Ranges::Details
{
    ...
    template <Ranges::Concepts::BidirectionalRange TRange>
    template <Ranges::Concepts::BidirectionalRange URange>
    constexpr ReverseRange<TRange>::ReverseRange(Immutable<URange> range) noexcept
        : range_(range)
    {
