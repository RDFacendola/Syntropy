...
/// \brief This header is part of the Syntropy core module. It contains implementation details about zip-ranges.
///
...
namespace Syntropy::Ranges::Details
{
    ...
    {
        template <Ranges::Concepts::ForwardRange... TRanges>
        friend constexpr auto Unzip(Immutable<ZipRange<TRanges...>> range) noexcept;
    ...
    public:
        ...
        constexpr ZipRange(Immutable<ZipRange> rhs) noexcept = default;
    ...
    template <Ranges::Concepts::ForwardRange... TRanges>
    [[nodiscard]] constexpr auto Unzip(Immutable<ZipRange<TRanges...>> range) noexcept;
...
namespace Syntropy::Tuples::Templates
{
    ...
    struct ElementTypeTraits<VIndex, Syntropy::Ranges::Details::ZipRange<TRanges...>> : Syntropy::Templates::Alias<ElementType<VIndex, Tuples::Tuple<TRanges...>>> {};

    /// \brief Partial template specialization for tuples.
    template <Syntropy::Ranges::Concepts::ForwardRange... TRanges>
    struct RankTypeTraits<Syntropy::Ranges::Details::ZipRange<TRanges...>> : Syntropy::Templates::IntConstant<sizeof...(TRanges)> {};
}
...
namespace Syntropy::Ranges::Details
{
    ...
    template <Ranges::Concepts::ForwardRange... TRanges>
    [[nodiscard]] constexpr decltype(auto) ZipRange<TRanges...>::GetFront() const noexcept
    {
    ...
    template <Ranges::Concepts::ForwardRange... TRanges>
    [[nodiscard]] constexpr auto ZipRange<TRanges...>::PopFront() const noexcept
    {
    ...
    template <Ranges::Concepts::ForwardRange... TRanges>
    [[nodiscard]] constexpr Bool ZipRange<TRanges...>::IsEmpty() const noexcept
    {
    ...
    template <Ranges::Concepts::ForwardRange... TRanges>
    [[nodiscard]] constexpr auto ZipRange<TRanges...>::GetCount() const noexcept
    {
    ...
    template <Ranges::Concepts::ForwardRange... TRanges>
    [[nodiscard]] constexpr decltype(auto) ZipRange<TRanges...>::GetBack() const noexcept
    {
    ...
    template <Ranges::Concepts::ForwardRange... TRanges>
    [[nodiscard]] constexpr auto ZipRange<TRanges...>::PopBack() const noexcept
    {
    ...
    template <Ranges::Concepts::ForwardRange... TRanges>
    template <typename TIndex>
    [[nodiscard]] constexpr decltype(auto) ZipRange<TRanges...>::At(Immutable<TIndex> index) const noexcept
    {
    ...
    template <Ranges::Concepts::ForwardRange... TRanges>
    template <typename TIndex, typename TCount>
    [[nodiscard]] constexpr auto ZipRange<TRanges...>::Slice(Immutable<TIndex> index, Immutable<TCount> count) const noexcept
    {
    ...
    requires Ranges::Concepts::ContiguousRange<URange>
    [[nodiscard]] constexpr auto ZipRange<TRanges...>::GetData() const noexcept
    {
