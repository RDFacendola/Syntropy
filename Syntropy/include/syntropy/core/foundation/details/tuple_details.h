...
namespace Syntropy::Details
{
    ...
    /// \brief Enable default tuple constructor if all types in TTypeList are default constructible.
    template <typename TTypeList>
    using TupleDefaultConstructorEnableIf = Templates::EnableIf<Templates::IsDefaultConstructible<TTypeList>>;
    ...
    template <typename TTypeList>
    inline constexpr Bool IsTupleDefaultConstructorExplicit = !Templates::IsImplicitlyDefaultConstructible<TTypeList>;
