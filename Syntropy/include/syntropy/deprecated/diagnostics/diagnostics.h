...
namespace syntropy::diagnostics
{
    ...
    struct StackTraceElement
    {
        ...
        String file_;              ///< \brief Name of the file.

        String function_;          ///< \brief Name of the function.
    ...
    struct StackTrace
    {
        ...
        Vector<StackTraceElement> elements_;                       ///< \brief Elements inside the stack trace, from the most recent one.
    };
