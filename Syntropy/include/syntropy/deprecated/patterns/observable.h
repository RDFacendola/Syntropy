...
namespace syntropy
{
    ...
    private:
        ...
        Vector<std::shared_ptr<void>> listeners_;
    ...
    protected:
        ...
        mutable Vector<std::weak_ptr<TListener>> listeners_;           ///< \brief Listeners subscribed to this object. Mutable needed to subscribe to const events.
    };
