...
namespace syntropy::platform
{
    ...
    struct DriveInfo 
    {
        String label_;                 ///< \brief Unit letter or label.
    ...
    struct StorageInfo
    {
        Vector<DriveInfo> drives_;     ///< \brief List of fixed, physical drives currently available.
    };
    ...
    struct MonitorInfo
    {
        String monitor_name_;              ///< \brief Name of the monitor.
        String adapter_name_;              ///< \brief Name of the adapter (GPU) the monitor is attached to.
    ...
    struct DisplayInfo
    {
        Vector<MonitorInfo> monitors_;     ///< \brief List of available monitors.
    };
