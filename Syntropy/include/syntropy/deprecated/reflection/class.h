...
namespace Syntropy::reflection
{
    ...
    public:
        ...
        const Vector<Property>& GetProperties() const noexcept;
    ...
    protected:
        ...
        Vector<Label> name_aliases_;        ///< \brief Class name aliases.

        Vector<const Class*> base_classes_;        ///< \brief List of all base classes.

        Vector<Property> properties_;              ///< \brief Class properties.
