...
namespace Syntropy
{
    ...
    {
        Functional::LockstepApply([&rhs](auto& lhs_element, const auto& rhs_element){ lhs_element = rhs_element; }, *this, rhs);
    ...
    {
        Functional::LockstepApply([&rhs](auto& lhs_element, auto&& rhs_element) { lhs_element = Move(rhs_element); }, *this, rhs);
    ...
    constexpr Bool operator==(const TupleT<TTypes...>& lhs, const TupleT<UTypes...>& rhs) noexcept
    {
        ...
        Functional::LockstepApply([&result](const auto& lhs_element, const auto& rhs_element)
        {
