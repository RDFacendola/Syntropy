...
/// \brief This header is part of Syntropy language module. It contains implementation details of invoke definitions.
///
...
namespace Syntropy::Templates::Details
{
    ...
    template <typename TCallable>
    using FunctionArguments = typename FunctionArgumentsHelper<TCallable>::Type;
