...
/// \file memory.h
/// \brief This header is part of the Syntropy memory module. It contains generic functionalities used to manage memory.
///
...
namespace syntropy
{
    ...
    /// \brief Exposes utility memory-related functionalities.
    namespace Memory
    {
