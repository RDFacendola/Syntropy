...
#include "syntropy/core/containers/map.h"
...
namespace Syntropy
{
    ...
    Context::Registry::Registry()
        : memory_resource_(std::forward_as_tuple(1_MiBytes, 64_KiBytes), FallbackAllocator<VirtualStackAllocator, SystemAllocator>::DefaultConstruct{})
