...
namespace Syntropy
{
    ...
    namespace Math
    {
        ...
        /// \brief Get the smallest integral number greater than or equal to
        ///        rhs.
        template <typename TNumber>
        [[nodiscard]] constexpr TNumber
        Ceil(TNumber rhs);

        /// \brief Get the largest integral number smaller than or equal to
        ///        rhs.
        template <typename TNumber>
        [[nodiscard]] constexpr TNumber
        Floor(TNumber rhs);
        ...
        /// \return Returns the first number equal or greater than number
        ///         which is multiple of multiple.
        template <typename TNumber>
        [[nodiscard]] constexpr TNumber
        Ceil(TNumber rhs, TNumber multiple);

        /// \brief Floor a number to a multiple.
        /// \return Returns the first number equal or lesser than number which
        ///         is multiple of multiple.
        template <typename TNumber>
        [[nodiscard]] constexpr TNumber
        Floor(TNumber rhs, TNumber multiple);

        /// \brief Divide lhs by rhs and ceil the result to the next integer
        ///        value.
        ...
        /// \brief Divide lhs by rhs and floor the result to the previous
        ///        integral value.
