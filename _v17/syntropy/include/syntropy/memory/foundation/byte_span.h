...
namespace Syntropy
{
    ...
    namespace Memory
    {
        /// \brief Consume lhs from the front until its first byte is aligned
        ///        to rhs or lhs is exhausted.
        [[nodiscard]] ByteSpan
        ...
        /// \brief Consume lhs from the back until its size is a multiple of
        ///        size or lhs is exhausted.
        [[nodiscard]] ByteSpan
        ...
        /// \remarks If rhs is not exactly TObject, accessing the returned
        ...
        /// \brief Get the object representation of elements in a contiguous
        ///        range.
        ...
        /// \remarks If rhs is not exactly a range TRange, accessing the
