...
namespace Syntropy::Support::UnitTest
{
    /************************************************************************/
    /* SEARCH TEST FIXTURE                                                  */
    /************************************************************************/
    ...
    {
        SYNTROPY_UNIT_EQUAL(Support::Find(fixture.ints_span_, 4), (Span<Int>{ &fixture.ints_[4], 6}));
    })

    .TestCase("Searching a range for a non-existent value returns an empty range.", [](auto& fixture)
    {
        SYNTROPY_UNIT_EQUAL(IsEmpty(Support::Find(fixture.ints_span_, 11)), true);
    })
    ...
    {
        SYNTROPY_UNIT_EQUAL(Support::FindReverse(fixture.ints_span_, 4), (Span<Int>{ &fixture.ints_[0], 5}));
    })

    .TestCase("Searching a reverse range for a non-existent value returns an empty range.", [](auto& fixture)
    {
        SYNTROPY_UNIT_EQUAL(IsEmpty(Support::FindReverse(fixture.ints_span_, 11)), true);
    })
    ...
    {
        SYNTROPY_UNIT_EQUAL(Support::FindIf(fixture.ints_span_, &SearchTestFixture::IsOdd), (Span<Int>{ &fixture.ints_[1], 9}));
    })

    .TestCase("Searching a range by a predicate which is false for all the range elements returns an empty range.", [](auto& fixture)
    {
        SYNTROPY_UNIT_EQUAL(IsEmpty(Support::FindIf(fixture.ints_span_, &SearchTestFixture::Never)), true);
    })
    ...
    {
        SYNTROPY_UNIT_EQUAL(Support::FindIfReverse(fixture.ints_span_, &SearchTestFixture::IsEven), (Span<Int>{ &fixture.ints_[0], 9}));
    })
    ...
    {
        SYNTROPY_UNIT_EQUAL(IsEmpty(Support::FindIfReverse(fixture.ints_span_, &SearchTestFixture::Never)), true);
    });
