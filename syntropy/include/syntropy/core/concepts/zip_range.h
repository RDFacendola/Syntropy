...
namespace Syntropy::Ranges
{
    ...
    /// \brief
    /// Adapter class used to zip many ranges together.
    ...
    /// \brief
    /// Create a new range by element-wise joining different ranges and
    ...
    /// \brief
    /// Unzip a range, producing a tuple containing the individual ranges.
    ///
    /// \remarks
    /// If the provided range is not a Zip-range, the results is a tuple with
    /// a single element.
