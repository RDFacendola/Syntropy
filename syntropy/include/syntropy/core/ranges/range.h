...
namespace Syntropy
{
    ...
    namespace Ranges::Extensions
    {
        ...
        /// \brief Discard the last element in a range view and return a view
        ///        to the remaining elements.
        template <typename TRangeView, typename = void>
        struct PopBack;
        ...
        ///
        /// \remarks Exceeding range view boundaries results in undefined
        ///          behavior.
        template <typename TRangeView, typename = void>
        struct At;
    ...
    namespace Ranges
    {
        ...
        /// \brief Discard the last element in a range and return a range to
        ///        the remaining elements.
        ///
        /// \remarks Undefined behavior if the range is empty.
        template <typename TRange>
