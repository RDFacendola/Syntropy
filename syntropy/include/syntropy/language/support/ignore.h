...
namespace Syntropy
{
    ...
    /// \brief Placeholder class type which can be constructed or called with
    ///        any argument and does nothing in either case.
    /// This type can be used to discard arguments
    //  the caller is not interested to.
