...
namespace Syntropy::Templates::Details
{
    ...
    RatioTypeHelper = false;

    /// \brief Specialization for Ratio<>.
    template <Int VNumerator, Int VDenominator>
    inline constexpr Bool
    RatioTypeHelper<Templates::Ratio<VNumerator, VDenominator>> = true;
    ...
    ReducedRatioNumerator = std::ratio<VNumerator, VDenominator>::num;

    /// \brief Reduced ratio denominator.
    template <Int VNumerator, Int VDenominator>
    inline constexpr Int
    ReducedRatioDenominator = std::ratio<VNumerator, VDenominator>::den;
    ...
    inline constexpr Int
    CommonRatioNumerator = Templates::GCD<TRatio::kNumerator,
                                          URatio::kNumerator>;

    /// \brief Common ratio denominator.
    template <typename TRatio, typename URatio>
    inline constexpr Int
    CommondRatioDenominator = Templates::LCM<TRatio::kDenominator,
                                             URatio::kDenominator>;
