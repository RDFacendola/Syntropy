...
namespace Syntropy::Memory
{
    ...
    {
        friend
        Mutable<BaseAllocator> GetSystemAllocator() noexcept;

        friend
        Mutable<BaseAllocator> GetAllocator() noexcept;

        friend
        Mutable<BaseAllocator> SetAllocator(Mutable<BaseAllocator>) noexcept;
    ...
    private:
        ...
        [[nodiscard]] static
        Mutable<RWPtr<BaseAllocator>> GetScopeAllocator() noexcept;
    ...
    public:
        ...
        [[nodiscard]] virtual
        RWByteSpan Allocate(Bytes size,
