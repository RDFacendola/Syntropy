...
namespace Syntropy::reflection
{
    ...
    const Vector<Label>& Class::GetNameAliases() const noexcept
    {
        return name_aliases_;
    }

    const Vector<const Class*>& Class::GetBaseClasses() const noexcept
    {
    ...
    const Vector<Property>& Class::GetProperties() const noexcept
    {
        return properties_;
    }
