...
namespace Syntropy::unit_test
{
    ...
    {
        constexpr auto Templates_GCD_45_25 = Templates::GCD<45, 25>::value_;
    ...
    {
        constexpr auto Templates_GCD_45_25 = Templates::GCD<45, 25>::value_;
        constexpr auto Templates_GCD_25_45 = Templates::GCD<25, 45>::value_;
    ...
    {
        constexpr auto Templates_GCD_47_47 = Templates::GCD<47, 47>::value_;
    ...
    {
        constexpr auto Templates_GCD_45_1 = Templates::GCD<45, 1>::value_;
        constexpr auto Templates_GCD_1_42 = Templates::GCD<1, 42>::value_;
    ...
    {
        constexpr auto Templates_GCD_45_0 = Templates::GCD<45, 0>::value_;
    ...
    {
        constexpr auto Templates_GCD_17_23 = Templates::GCD<17, 23>::value_;
    ...
    {
        constexpr auto Templates_GCD_49_81 = Templates::GCD<49, 81>::value_;
    ...
    {
        constexpr auto Templates_LCM_105_84 = Templates::LCM<105, 84>::value_;
    ...
    {
        constexpr auto Templates_LCM_0_0 = Templates::LCM<0, 0>::value_;
    ...
    {
        constexpr auto Templates_LCM_105_84 = Templates::LCM<105, 84>::value_;
        constexpr auto Templates_LCM_84_105 = Templates::LCM<84, 105>::value_;
    ...
    {
        constexpr auto Templates_LCM_45_1 = Templates::LCM<45, 1>::value_;
        constexpr auto Templates_LCM_1_42 = Templates::LCM<1, 42>::value_;
    ...
    {
        constexpr auto Templates_LCM_45_45 = Templates::LCM<45, 45>::value_;
    ...
    {
        constexpr auto Templates_LCM_17_23 = Templates::LCM<17, 23>::value_;
