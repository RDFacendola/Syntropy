...
#include "syntropy/types/observer_ptr.h"
...
int main(int argc, char **argv)
 {
    ...
    auto hw0 = syntropy::Label{ "Hello world!" };
    auto hw1 = syntropy::Label{ "Hello World!" };
    auto hw2 = syntropy::Label{ "Hello world!" };

    auto ptr0 = syntropy::MakeObserver(&hw0);
    auto ptr1 = syntropy::MakeObserver(&hw1);
