...
syntropy::Vector<syntropy::TestCase> TestSyntropySerialization::GetTestCases()
{
    return
    {
...
void TestSyntropySerialization::TestSerialization()
{
    ...
    std::optional<syntropy::serialization::JSON> json = SerializeObjectToJSON(Petto);
...
void TestSyntropySerialization::TestDeserialization()
{
    ...
    syntropy::serialization::JSON json = R"({
                                "Name": "Kitty",
                                "float_value": 67.5,
                                "const_value": 100.0,
                                "boolean": true,
