...
const std::vector<TestSynapseSearch::GraphNode*>& TestSynapseSearch::GraphNode::GetNeighbors() const
{
    return neighbors_;
}
...
std::vector<syntropy::TestCase> TestSynapseSearch::GetTestCases()
{
    return
    {
